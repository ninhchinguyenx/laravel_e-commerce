                            ...
                            <div class="row justify-content-center g-0">
                                        ...
                                        <div class="position-relative h-100 d-flex flex-column">
                                            <div class="mb-4">
                                                <a href="index.html" class="d-block">
                                                    <img src="backend/assets/images/logo-light.png" alt="" height="18">
                                                </a>
                                            </div>
                                            <div class="mt-auto">
                                                <div class="mb-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            <h5 class="text-primary">Đănh nhập vào Admin</h5>
                                        ...
                                        <div class="mt-4">
                                            <form class="" action="{{route('auth.login')}}" method="post">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    @error('email')
                                                        <div class="text-danger fst-italic mt-1">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label" for="password-input">Mật khẩu</label>
                                                    <div class="position-relative auth-pass-inputgroup">
                                                        <input type="password" class="form-control pe-5 password-input" onpaste="return false" placeholder="Nhập mật khẩu" id="password-input" name="password">
